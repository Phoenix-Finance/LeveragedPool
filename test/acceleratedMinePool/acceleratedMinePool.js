...
let testInfo = require("../leveragePool/testInfo.js");
contract('acceleratedMinePool', function (accounts){
    it('acceleratedMinePool buying mine functions', async function (){
        ...
        let pool = await acceleratedMinePool.new(multiSign.address);
        await testInfo.multiSignatureAndSend(multiSign,pool,"setMineCoinInfo",accounts[0],owners,collateral0,10000000000,3000)
        let ppt = await PPTCoin.new(multiSign.address);
