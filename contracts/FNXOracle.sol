...
contract FNXOracle is Operator {
    ...
    /**
      ...
      */    
    function setPrice(address asset,uint256 price) public onlyOperator(0) {
    ...
    /**
      ...
      */  
    function setUnderlyingPrice(uint256 underlying,uint256 price) public onlyOperator(0) {
    ...
    */    
    function setPriceAndUnderlyingPrice(address[] memory assets,uint256[] memory assetPrices,uint256[] memory underlyings,uint256[] memory ulPrices) public onlyOperator(0) {
    ...
    /**
      ...
      */     
    function setSellOptionsPrice(address optoken,uint256 price) public onlyOperator(0) {
    ...
    /**
      ...
      */      
    function setBuyOptionsPrice(address optoken,uint256 price) public onlyOperator(0) {
    ...
    /**
      ...
      */    
    function setOptionsBuyAndSellPrice(address[] memory optokens,uint256[] memory buyPrices,uint256[] memory SellPrices) public onlyOperator(0) {
